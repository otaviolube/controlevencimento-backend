...
app.get('/usuario', function(req, res) {
    app.app.controllers.userController.lerUsuario(app, req, res);
});

app.get('/idUsuario/:id', function(req, res) {
    app.app.controllers.userController.idUsuario(app, req, res);
});

app.post('/usuario', function(req, res) {
    app.app.controllers.userController.cadastrar(app, req, res);
});

app.patch('/usuario', function(req, res) {
    app.app.controllers.userController.atualizar(app, req, res);
});

app.delete('/usuario/:id', function(req, res) {
    app.app.controllers.userController.deletar(app, req, res);
});
...
app.get('/idColaborador/:id', function(req, res) {
    app.app.controllers.companyController.idColaborador(app, req, res);
});
